<x-filament-panels::page>
    ...
    @if ($requests->count())
        <div class="w-full overflow-x-auto border border-gray-300 bg-white shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-300 px-4 py-4">
