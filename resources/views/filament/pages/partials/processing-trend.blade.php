<section class="processing-trend" aria-labelledby="processing-trend-title">
    <div class="processing-trend-heading">
        <h2 id="processing-trend-title">Daily processed</h2>
        <span class="processing-trend-period">Last 7 days</span>
    </div>
    @php
    ...
    @endphp
    <svg class="processing-trend-line" viewBox="0 0 400 120" role="img" aria-labelledby="processing-line-title">
        ...
        @for($value = 0; $value <= $ceiling; $value += 5)
            ...
            <path d="M36 {{ $y }} H378" class="processing-trend-grid" />
        @endfor
